        ...
        <div class="col-sm-offset-2 col-sm-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body collapse" id="collapseOne">
                    ...
                    <!-- New Transections Form -->
                    <form action="{{ url('transection') }}" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
                        
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="input-budget-date">Date</label>
                            <div class="col-sm-6">
                                <input type="text" id="input-budget-date" name="transection_date" value="{{ $date_to }}" required> 
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="input-budget-description">Description</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" rows="3" id="input-budget-description" name="description" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="input-budget-actual">Actual</label>
                            <div class="col-sm-6">
                                <input class="form-control" type="text" id="input-budget-actual" name="actual" placeholder="1700" required>
                            </div>
                        </div>
                    ...
                    <div class="panel-heading">
                        <div class="text-left">
                            <form class="form-inline" id="filters" method="post" action="javascript:void(0)">
                                ...
                                <input type="hidden" value="transection" id="search_type">
                                <div class="form-group">
                                    <label>Transections from : </label>
                                    <input class="form-control" type="text" name="date_from" value="{{ $date_from }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword3">to</label>
                                     <input class="form-control" type="text" name="date_to" value="{{ $date_to }}">
                                </div>
